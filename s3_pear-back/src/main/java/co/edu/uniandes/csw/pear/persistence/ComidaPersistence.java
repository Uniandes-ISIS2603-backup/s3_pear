...
public class ComidaPersistence {
    ...
    public void delete( Long id ) {
        ...
        System.out.println(String.format("Eliminandola entitad de Comida con ID = { %s } donde la lista tiene < %d > elementos", new Object[]{entity.getId().toString(), this.findAll().size()}));
        em.remove(entity);
