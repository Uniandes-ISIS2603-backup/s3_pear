...
public class QuejasyReclamosResource 
{
     ...
     * </code>
     * </pre>
     * @param quejayreclamo {@link quejayreclamoDetailDTO} - La queja y reclamo que se desea guardar.
     * @return JSON {@link QuejasyReclamosDetailDTO}  - La queja y reclamo guardada con el atributo id autogenerado.
     ...
     * </pre>
     * @return JSONArray {@link CityDetailDTO} - Las quejas y reclamos encontradas en la aplicación. Si no hay ninguna retorna una lista vacía.
     */
    @GET
    ...
    /**
     * <h1>PUT /api/quejasyreclamos/{id} : Actualizar queja y reclamo con el id dado.</h1>
     ...
     * </code> 
     * </pre>
     * @param id Identificador de la queja que se desea actualizar.Este debe ser una cadena de dígitos.
     * @param quejayreclamo {@link QuejassyReclamosDetailDTO} La queja que se desea guardar.
