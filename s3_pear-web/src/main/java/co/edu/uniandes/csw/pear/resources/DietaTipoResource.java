 ...
 *  "descripcion": String,
 *  "cuentaDeCobro": {
 *                    "valorAPagar": double // FALTA TERMINAR ESTO
 *                  }
 *  "semanas" : [
 *               {
 *                  "fechaLunes" : String // FALTA TERMINAR ESTO
 *                }
 *              ]
 * }
 * @author js.garcial1
...
public class DietaTipoResource {
    ...
    @PUT
    @Path("{id: \\d+}")
    public DietaTipoDetailDTO updateCity(@PathParam("id") Long id, DietaTipoDetailDTO dieta) {
